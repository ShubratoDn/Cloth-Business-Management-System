...
public class PurchaseX {
    ...
    private List<TradeTransactionDetails> purchaseDetails;
...
//    private String discountRemark;
//
//    private Double additionalChargeAmount; // Changed from chargeAmount to additionalChargeAmount
//    private String additionalChargeRemark; // Changed from chargeRemark to additionalChargeRemark
//  
//    @Temporal(TemporalType.DATE)
//    @DateTimeFormat(pattern = "yyyy-MM-dd") // Ensure this matches the format you're using in the frontend
